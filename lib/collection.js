...
Collection = (function() {
  ...
  Collection.prototype._find = function(params, options, fn) {
    var ref;
    ref = utils.normalize(params, options, fn), params = ref.params, options = ref.options, fn = ref.fn;
    this.db.open(this.name, function(err, col) {
      var cursor, field, fields, i, len, ref1;
      if (err) {
        fn(err, []);
        return;
      }
  ...
  Collection.prototype.findOne = function(params, options, fn) {
    ...
    this._find(params, options, function(error, response) {
      var ref1;
      response = (ref1 = response[0]) != null ? ref1 : false;
      fn(error, response);
    });
  };
  ...
  Collection.prototype.findById = function(id, fields, fn) {
    ...
    this._find(params, options, function(error, response) {
      var ref;
      response = (ref = response[0]) != null ? ref : false;
      fn(error, response);
    });
  };
  ...
  Collection.prototype.save = function(params, fn) {
    var ref;
    ref = utils.normalize(params, fn), params = ref.params, fn = ref.fn;
    this.db.open(this.name, function(err, col) {
      if (err) {
        fn(err, []);
        return;
  ...
  Collection.prototype.update = function(params, data, fn) {
    var options, ref;
    ref = utils.normalize(params, data, fn), params = ref.params, options = ref.options, fn = ref.fn;
    this.db.open(this.name, function(err, col) {
      if (err) {
        fn(err, false);
        return;
